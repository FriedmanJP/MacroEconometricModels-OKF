...
| [nowcast](https://github.com/FriedmanJP/MacroEconometricModels.jl/blob/3d12bb6c/src/nowcast/forecast.jl) | `nowcast(model::AbstractNowcastModel; target_var=nothing) -> NowcastResult` | Current-quarter estimate plus short-horizon forecast (3 steps DFM, 1 step BVAR, repeated nowcast for bridge) |
