...
| [policy_causal_effects](https://github.com/FriedmanJP/MacroEconometricModels.jl/blob/3d12bb6c/src/counterfactual/empirical.jl) | `policy_causal_effects(ir::ImpulseResponse, shocks, outcomes, instruments=[]; H, normalize=:none, source=:var)` | Causal-effects container from VAR IRFs (bootstrap draws when present) |
...
| [policy_causal_effects](https://github.com/FriedmanJP/MacroEconometricModels.jl/blob/3d12bb6c/src/counterfactual/empirical.jl) | `policy_causal_effects(s::SignIdentifiedSet, shocks, outcomes, instruments=[]; H, normalize=:none)` | Causal-effects container from sign-identified IRF draws |
| [policy_causal_effects](https://github.com/FriedmanJP/MacroEconometricModels.jl/blob/3d12bb6c/src/counterfactual/empirical.jl) | `policy_causal_effects(m::Union{LPModel,LPIVModel}, outcomes, instruments=[]; kwargs...)` | Causal-effects container via `lp_irf` / `lp_iv_irf` |
...
| [OPPConstraint](https://github.com/FriedmanJP/MacroEconometricModels.jl/blob/3d12bb6c/src/counterfactual/constrained.jl) | `abstract type OPPConstraint` | Supertype for constrained-OPP constraints |
| [PathFloorConstraint](https://github.com/FriedmanJP/MacroEconometricModels.jl/blob/3d12bb6c/src/counterfactual/constrained.jl) | `struct PathFloorConstraint{T} <: OPPConstraint` | Linear instrument path-floor (e.g. ZLB) constraint |
| [FunctionConstraint](https://github.com/FriedmanJP/MacroEconometricModels.jl/blob/3d12bb6c/src/counterfactual/constrained.jl) | `struct FunctionConstraint <: OPPConstraint` | User-function nonlinear constraint |
...
| [robust_weights](https://github.com/FriedmanJP/MacroEconometricModels.jl/blob/3d12bb6c/src/counterfactual/opp_sequence.jl) | `robust_weights(seq_builder, theta_grid)` | BM robust-preferences extraction: loss weight making past policy look most optimal |
